...
def check_events(ai_settings, screen, stats, play_button, ship, bullets, aliens, sb):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            save_and_exit(stats, ai_settings)
...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship, aliens,
    ...
    if button_clicked and not stats.game_active:
        ...
        start_game(stats, ai_settings, screen, ship,  aliens, bullets, sb)
...
def get_number_stars_x_y(ai_settings, star_width, star_height):
...
def start_game(stats, ai_settings, screen, ship, aliens, bullets, sb):
...
def save_and_exit(stats, ai_settings):
    path = ai_settings.path
